...
<head>
    ...
    <title>Add MHP - BrighterDays Admin Dashboard</title>
    <link rel="shortcut icon" href="../imgs/_.jpeg" type="image/png">
    <link rel="stylesheet" href="assets/dist/extensions/datatables.net-bs5/css/dataTables.bootstrap5.min.css">
            ...
            <div class="sidebar-wrapper active">
                <div class="sidebar-header position-relative">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="logo">
                            <a href="index.html"><img src="../imgs/_.jpeg" alt="Logo" srcset=""></a>
                        </div>
                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <li class="sidebar-item  active">
                            <a href="../crud/manage-mhp.php" class='sidebar-link'>
                    ...
                    <section class="section">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form class="form" action="../process-add-nhp.php" method="post" enctype="multipart/form-data">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="name-column" class="form-control" placeholder="Name" name="first_name" id="name required">
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                <label for="name">Lastname</label>
                                                <input type="text" id="name-column" class="form-control" placeholder="Name" name="last_name" id="name required">
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="Phone-number" class="form-control" name="phone" placeholder="Phone number" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
